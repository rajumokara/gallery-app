      ...
      <>
        <div className="galleryContainer">
          <div className="galleryImages">
            <img src={imageUrl} alt={imageAltText} width="600px" />
          ...
          <div className="thumbnailContainer">
            <ul>
              {imagesList.map(thumbnailImage => (
                <ThumbnailItem
                  thumbnailImageList={thumbnailImage}
                  key={thumbnailImage.id}
                  getUpdatedImageList={this.getUpdatedImageList}
                  isActive={activeThumbnailId === thumbnailImage.id}
                />
              ))}
            </ul>
          </div>
